...
=#
module Foo #создать модуль, 
import Base.show # подключение библиотеки
export MyType, foo # структуры/функции, которые можно будет использовать за пределами модуля
struct MyType 
    x
end
